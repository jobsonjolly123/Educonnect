...
if(isset($_POST['register']))
{
    ...
    $sql = "INSERT INTO TEACHERS (first_name,last_name,email,phone,department,batch_no,position,password)
     VALUES('$firstname','$lastname','$email','$phone','$department','$batchno','$pos','$password')";
...
<body>
    <div class="box">
        <div class="container">
            ...
            <div class="input-field">
                <input type="number" class="input" placeholder="Batch No" name="batch_no" required> 
            </div>
            <div class="input-field">
